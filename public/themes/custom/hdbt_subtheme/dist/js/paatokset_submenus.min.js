...
(() => {
  ...
  (function($, Drupal, once2) {
    ...
    __name(handleListVisibility, "handleListVisibility");
    ...
    __name(handleDropdownToggle, "handleDropdownToggle");
    ...
    __name(showSelected, "showSelected");
    ...
    Drupal.behaviors.myBehavior = {
      attach(context) {
        once2("paatokset_submenus", "html", context).forEach(function() {
          handleListVisibility();
